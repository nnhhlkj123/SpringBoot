		...
		<div class="row">
			...
			<div class="col-md-4 col-sm-6 pre-footer-col">
				...
				<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed
					diam sit nonummy nibh euismod tincidunt ut laoreet dolore magna
					aliquarm erat sit volutpat.</p>

				<div class="photo-stream">
					<h2>Photos Stream</h2>
					<ul class="list-unstyled">
						<li><a href="#"><img alt=""
								src="templates/assets/frontend/pages/img/people/img5-small.jpg"></a></li>
						<li><a href="#"><img alt=""
								src="templates/assets/frontend/pages/img/works/img1.jpg"></a></li>
						<li><a href="#"><img alt=""
								src="templates/assets/frontend/pages/img/people/img4-large.jpg"></a></li>
						<li><a href="#"><img alt=""
								src="templates/assets/frontend/pages/img/works/img6.jpg"></a></li>
						<li><a href="#"><img alt=""
								src="templates/assets/frontend/pages/img/works/img3.jpg"></a></li>
						<li><a href="#"><img alt=""
								src="templates/assets/frontend/pages/img/people/img2-large.jpg"></a></li>
						<li><a href="#"><img alt=""
								src="templates/assets/frontend/pages/img/works/img2.jpg"></a></li>
						<li><a href="#"><img alt=""
								src="templates/assets/frontend/pages/img/works/img5.jpg"></a></li>
						<li><a href="#"><img alt=""
								src="templates/assets/frontend/pages/img/people/img5-small.jpg"></a></li>
						<li><a href="#"><img alt=""
								src="templates/assets/frontend/pages/img/works/img1.jpg"></a></li>
